    ...
    return(<div className={styles.about}>
        ...
        <div className={styles.container}>
            <div className={styles.description}>
                ...
                <p>
                Asura adalah ruang pribadi yang dibangun untuk berbagi cerita, pengalaman, serta berbagai informasi yang dipelajari dalam perjalanan hidup. Nama Asura sendiri diambil dari kata Asu dan Ora dalam bahasa jawa, yang berarti Bukan Anjing.
                </p>
                <p>
